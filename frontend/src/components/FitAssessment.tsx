...
const FitAssessment = () => {
  ...
  const selectedTab: TabType =
    hasExamples && activeTab === 'custom' && !customJD.trim()
      ? 'example1'
      : activeTab;
    ...
    return (
      <section id="fit-assessment" className="py-24 px-6 bg-secondary/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mt-4">正在加载岗位匹配分析...</p>
        </div>
      </section>
    );
  }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          {example1 && (
            <button
              role="tab"
              aria-selected={selectedTab === 'example1'}
